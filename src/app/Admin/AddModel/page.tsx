...
import styles from './add-model.module.css';
import React, { useState } from 'react';
import Swal from 'sweetalert2';
import { useMutation, useQuery } from '@apollo/client';
import { GET_ALL_VEHICLES_MUTATION, ADD_VEHICLE_MUTATION, GET_ALL_MAKES_MUTATION } from '@/graphql/mutations';
...
const AddModel = () => {
  ...
  const { loading: loadingMakes, error: errorMakes, data: makesData } = useQuery<MakesData>(GET_ALL_MAKES_MUTATION);
  ...
  return (
    <div className={styles.container}>
      <div className={styles.addvehicleContainer}>
        <h1 className={styles.header}>Add Make</h1>
    ...
    >
      ...
      {makesData?.getAllMakesQuery.map((make) => (
      ...
      <div className={styles.addvehicleTableContainer}>
