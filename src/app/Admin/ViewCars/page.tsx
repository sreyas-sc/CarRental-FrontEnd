...
//   const [uploadImage] = useMutation<UploadImageResponse>(UPDATE_IMAGE, {
//     onError: (error) => {
...
//       if (result.data?.uploadImage.success) {
//         setNewPrimaryImageUrl(result.data.uploadImage.url);
//         Swal.fire('Success!', 'Image uploaded successfully', 'success');
//       } else {
//         throw new Error(result.data?.uploadImage.message || 'Failed to upload image');
//       }
//     } catch (error) {
        ...
        <div className={styles.popup}>
          <div className={styles.popupContent}>
            ...
            <form onSubmit={handleUpdate} className={styles.form}>
              ...
              <div className={styles.additionalImagesPreview} onClick={() => additionalImagesInputRef.current?.click()}>
                <input
                  type="file"
